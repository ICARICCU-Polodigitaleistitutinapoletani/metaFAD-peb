# metaFAD PEB - Portal Entity Builder
Libreria ed editor per la gestione di ontologie in metaFAD.
...
# Licenza
"metaFAD PEB" è rilasciato con licenza [BSD3](LICENSE)

"metaFAD PEB" utilizza una versione modificata di [WebVOWL](https://github.com/VisualDataWeb/WebVOWL), tale componente mantiene la licenza originale MIT.
